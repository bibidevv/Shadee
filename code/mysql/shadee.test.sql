...
DROP DATABASE IF EXISTS shadee_test;

-- créer la base de données 
CREATE DATABASE shadee_test; 

-- créer les tables 
CREATE TABLE shadee_test.role(
    id TINYINT(1) UNSIGNED AUTO_INCREMENT PRIMARY KEY,
    name VARCHAR (10) NOT NULL UNIQUE
);

CREATE TABLE shadee_test.product(
...
CREATE TABLE shadee_test.undertone(
    id TINYINT UNSIGNED AUTO_INCREMENT PRIMARY KEY,
    name VARCHAR(50) NOT NULL UNIQUE,
    description TEXT NOT NULL
);

CREATE TABLE shadee_test.product_undertone(
    product_id TINYINT UNSIGNED,
    undertone_id TINYINT UNSIGNED,
    FOREIGN KEY (product_id) REFERENCES shadee_test.product(id),
    FOREIGN KEY (undertone_id) REFERENCES shadee_test.undertone(id),
    PRIMARY KEY (product_id, undertone_id)
);

CREATE TABLE shadee_test.skin_type(
    id TINYINT UNSIGNED AUTO_INCREMENT PRIMARY KEY,
    name VARCHAR(50) NOT NULL UNIQUE,
    description TEXT NOT NULL
);

CREATE TABLE shadee_test.product_skin_type(
    product_id TINYINT UNSIGNED,
    skin_type_id TINYINT UNSIGNED,
    FOREIGN KEY (product_id) REFERENCES shadee_test.product(id),
    FOREIGN KEY (skin_type_id) REFERENCES shadee_test.skin_type(id),
    PRIMARY KEY (product_id, skin_type_id)
);

CREATE TABLE shadee_test.skin_color(
    id TINYINT UNSIGNED AUTO_INCREMENT PRIMARY KEY,
    name VARCHAR(50) NOT NULL UNIQUE,
    description TEXT NOT NULL,
...
CREATE TABLE shadee_test.product_skin_color(
    product_id TINYINT UNSIGNED,
    skin_color_id TINYINT UNSIGNED,
    FOREIGN KEY (product_id) REFERENCES shadee_test.product(id),
    FOREIGN KEY (skin_color_id) REFERENCES shadee_test.skin_color(id),
    PRIMARY KEY (product_id, skin_color_id)
);

CREATE TABLE shadee_test.user(
    id TINYINT UNSIGNED AUTO_INCREMENT PRIMARY KEY,
...
-- insérer des données 
INSERT INTO shadee_test.role
VALUES 
    (NULL,"admin"),
    (NULL, "user")
;

-- INSERT INTO shadee_test.product
-- VALUES
...
INSERT INTO shadee_test.undertone
VALUES
...
INSERT INTO shadee_test.skin_type
VALUES
...
INSERT INTO shadee_test.skin_color
VALUES
...
-- -- requête 2
-- INSERT INTO shadee_test.product_skin_color
-- VALUES
--     (@product_id, 1),
--     (@product_id, 2)
-- ;
...
-- INSERT INTO shadee_test.product_skin_type
-- VALUES
--     (@product_id, 1),
--     (@product_id, 2)
-- ;
...
-- INSERT INTO shadee_test.product_undertone
-- VALUES
--     (@product_id, 1),
--     (@product_id, 2),
--     (@product_id, 3)
...
-- DELETE FROM shadee_test.product_skin_color
-- WHERE 
--     product_skin_color.product_id = 1
-- ;

-- DELETE FROM shadee_test.product_skin_type
-- WHERE 
--     product_skin_type.product_id = 1
-- ;

-- DELETE FROM shadee_test.product_undertone
-- WHERE 
--     product_undertone.product_id = 1
-- ;

-- DELETE FROM shadee_test.product
-- WHERE
--     product.id = 1
-- ;
